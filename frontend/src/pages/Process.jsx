        ...
        <SwiperSlide>
          <div className="step animated-step fade-in-up">
            <div className="step-layout-horizontal">
              ...
              <div className="step-text">
                <h2>填丝</h2>
                <p>填丝是将制好的花丝填入轮廓内。填丝前按图纸要求将一定形态的丝掐成所需的图案轮廓，外轮廓掐好后，将制好的花丝纹路用镊子往里填，这一过程就叫填丝。填丝时注意排码丝要均匀齐整、平滑顺畅，而且填好的丝面要平，不能高低不一，档要疏密一致。填丝种类很多，常用的有填巩丝、填卷头、填花瓣、填各种锦地等……</p>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="step animated-step fade-in-up">
            <div className="step-layout-horizontal">
              ...
              <div className="step-text">
                <h2>焊接</h2>
                <p>焊接是花丝镶嵌作品中技术难度较高的一门技艺、不同于一般机械工程的焊接，这种焊接为特种工艺焊接。因为特种工艺焊接对象没有批量性，材料变化性大，所以焊接时一般凭技艺师傅的经验来确定焊药的品种、比例、多少，焊点的位置、数量，火势的大小，吹烧的时间等。焊药还分黄焊药和红焊药，根据所焊主体不同选择使用不同的焊药，焊接胎体就要用黄焊药，焊接花丝就要用红焊药，红焊药的流动性比黄焊药好。特别是在焊接高含金量的黄金作品时，为了保证作品的含金量，技艺师傅要将焊药配比达到“97料”、即焊药中97%为金，3%为其他材料，而且焊药不能多用，这就要求技艺师傅具有很高的焊接技艺。如焊接干足金的作品时，焊药要配好97药，为确保作品是千足金，经推算焊药用量不能超过一定量的克重。确定好焊药用量后，技艺师傅要在整体作品中根据不同结构情况、重量支撑点情况以及重要的连接处，找出焊接点，然后根据焊接点的数量和受力不同来分配焊药用量。在焊接的过程中要掌握好火候儿，不能使花丝熔裂，也不能使焊药熔流到他处。
                焊接时火候儿适当是关键，要手稳眼快，火候儿不够就会导致焊药开焊散活；火候儿过甚会使焊药流化，从而使花丝纹产生很多药疤。焊接时还要焊满，不能有不实的现象，焊接处不能留有大片焊迹，焊痕也要平整光滑。</p>
              </div>
            </div>
          </div>
          ...
          <div className="step animated-step fade-in-up">
            <div className="step-layout-horizontal">
              ...
              <div className="step-text">
                <h2>堆垒</h2>
                <p>花丝的堆垒实质是做一种花丝形态的两个步骤，一般用于制作非平面形花丝，如葫芦形瓶、壶等有曲面的立体造型的花丝。准垒花丝分平面垒丝和立体垒丝两种。平面垒丝同平填丝不同，平面垒丝是将两层以上的花丝纹样叠加在一起，以表现作品的立体效果。立体垒丝可在实胎或炭灰上叠码花丝纹样进行焊接。做立体造型的堆垒花丝，首先要按照图纸和设计要求将作品读懂，然后根据立体结构、尺寸，将木炭磨成粉末状，加入白戏和水后调成面状，用手捏成图纸所设计的造型，这也是一个塑型的过程，塑型后待干，这个过程就是堆。塑型干了后再绕码丝，也是垒丝的一个过程，在垒丝时也要和填丝一样，要一丝不苟地操作，要均匀平整，码得严丝合缝。只有这样，焊接时才能严密无缝隙。焊接后，用火把堆成的炭模烧掉，即成立体中空、玲珑剔透的成品。好的成品让外人找不到丝的来龙去脉。
                堆垒还有“堆松”，常用“松”做松叶、离兽、边缘纹样。准松的做法是将码丝再绕一次依次将每个圆圈剪下，将对口对严焊接好，再吹一个小珠放在上边焊好即成为“松”。</p>
              </div>
            </div>
          </div>
        </SwiperSlide> <SwiperSlide>
